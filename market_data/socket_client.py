...
class MDSocket_io:
    ...
    def __init__(self, token: str, userID: str):
        ...
        Args:
            token: Authentication token from market data login
            userID: User ID from market data login
        """
        self.token = token
        self.userID = userID
    ...
    def _load_config(self):
        """Load config.ini for XTS endpoints"""
        try:
    ...
    def _build_connection_url(self):
        """Build XTS Socket.IO connection URL"""
        publishFormat = 'JSON'
        self.connection_url = (
    ...
    def _register_event_handlers(self):
        ...
        # Other market data events (for completeness)
    ...
    def connect(self, headers: dict = None, transports: str = 'websocket', 
        ...
        Args:
            ...
            transports: Transport method ('websocket' or 'polling')
            namespaces: Socket.IO namespaces
            socketio_path: Socket.IO path on server
    ...
    # 1512 LTP HANDLERS (Most Important)
    ...
    def send_subscription(self, instruments: List[Dict], message_type: int = 1512) -> Dict:
        ...
        Args:
            instruments: List of instruments to subscribe
                Format: [{'exchangeSegment': 2, 'exchangeInstrumentID': 12345}, ...]
            message_type: XTS message code (1512 for LTP)
...
def test_connection():
    ...
    def on_connect():
        ...
        instruments = [
            {'exchangeSegment': 2, 'exchangeInstrumentID': 58725}  # Example: NIFTY FUT
        ]
